    ...
    <>
      ...
      {isOpen && (
        <PopupBackdrop className="animate-screen-shake">
          ...
          {/* Content */}
          <div 
            className="relative z-10 bg-background border-2 border-destructive rounded-2xl p-8 pb-12 md:pb-10 mb-20 md:mb-16 max-w-md mx-4 animate-scale-in shadow-2xl"
